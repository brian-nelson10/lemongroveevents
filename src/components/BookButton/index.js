...
//   const loaderControls = useAnimation();
  ...
  return (
    ...
    <motion.div 
      ...
      <div className="wrapper mr-[6.5rem] md:mr-[14rem] lg:mr-[18rem] xl:mr-[8rem] overflow-hidden cursor-pointer rounded-lg relative items-center justify-center" onClick={() => !isAnimating && animate()}>
        <motion.div 
