...
const PackageThree= () => {
    ...
    return (
        ...
        <section className="grid grid-cols-2 mx-[2rem] flex items-center h-[30%] w-vw mb-10 bg-fixed rounded-sm drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)] celeb-head">
  <motion.div 
    variants={pack}
    initial="initial"
    whileInView="animate"
...
<div className="container mx-auto xl:px-32 text-center lg:text-left">
  <div className="grid lg:grid-cols-2 flex items-center">
    <div className="mb-12 lg:mb-0">
      ...
      >
      <h3 class="text-[1.8rem] text-[#283845] font-roboto mb-6">Give your celebration the extra touch it needs with a special surprise waiting for you.</h3>
      <h5 class="text-xl text-[#283845] font-roboto font-bold tracking-wide ml-1 lg:mb-5 xl:mb-3">Let's make this getaway extra special.</h5>
<div className="grid grid-cols-3">
    <div className="col-span-3">
      <p className="font-bold text-end font-larissa text-[4rem] text-[#283845] tracking-widest -mt-[1rem] -mb-4 justify-start">Celebrate.</p>
      </div>
      </div>
...
<p className="font-larissa font-bold tracking-wide text-md -mt-7 -ml-3 opacity-0 group-hover:opacity-100">I do</p>
      </div>
